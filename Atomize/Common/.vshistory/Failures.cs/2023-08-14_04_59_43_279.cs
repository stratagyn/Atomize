...
internal static class Failure
{
    public static class DidNotExpect
    {
        ...
        public static Failure<T> Char<T>(Scanner reader, char token, int at, int start) =>
        ...
        public static Failure<T> EndOfText<T>(Scanner reader, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected not to match end of text.");

        public static Failure<T> Match<T>(Scanner reader, int at, int start) =>
            Undo<T>(reader, at, start, "Expected not to match rule");

        public static Failure<T> Regex<T>(Regex token, int at) =>
            new(at, $"Expected not to match {{/{token}/}}.");

        public static Failure<T> Regex<T>(Scanner reader, Regex token, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected not to match {{/{token}/}}.");
        ...
        public static Failure<T> Text<T>(Scanner reader, ReadOnlySpan<char> token, int at, int start) =>
    ...
    public static class Expected
    {
        ...
        public static Failure<T> Char<T>(Scanner reader, char[] tokens, int at, int start) =>
        ...
        public static Failure<T> Match<T>(Scanner reader, int at, int start) =>
            Undo<T>(reader, at, start, "Expected to match rule");
        ...
        public static Failure<T> EnoughMatchingTokens<T>(Scanner reader, int n, char token, int at, int start) =>
            Undo<T>(reader, at, start, $"Failed to match '{token}' {n} times.");

        public static Failure<T> EnoughMatchingTokens<T>(Scanner reader, int n, string token, int at, int start) =>
            Undo<T>(reader, at, start, $"Failed to match \"{token}\" {n} times.");

        public static Failure<T> EnoughMatchingTokens<T>(Scanner reader, int n, Regex token, int at, int start) =>
            Undo<T>(reader, at, start, $"Failed to match /{token}/ {n} times.");

        public static Failure<T> EnoughMatchingTokens<T>(Scanner reader, int n, int at, int start) =>
            Undo<T>(reader, at, start, $"Failed to match rule {n} times.");
        ...
        public static Failure<T> Regex<T>(Scanner reader, Regex[] tokens, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected to match one of {{{Utilities.Join(tokens)}}}.");
        ...
        public static Failure<T> Text<T>(Scanner reader, string[] tokens, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected to match one of {{{Utilities.Join(tokens)}}}.");
        ...
        public static Failure<T> ToPass<T>(Scanner reader, char token, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(string token, int at) =>
            new(at, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(Scanner reader, string token, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(T token, int at) =>
            new(at, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(Scanner reader, T token, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected {token} to pass predicate.");
    ...
    public static Failure<T> Undo<T>(Scanner reader, int at, int start, string message)
    {
