...
internal static class Failure
{
    ...
    public static class Expected
    {
        ...
        public static Failure<T> EnoughMatchingTokens<T>(TokenReader reader, int n, int at, int start) =>
        ...
        public static Failure<T> ToPass<T>(TokenReader reader, char token, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(string token, int at) =>
            new(at, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(TokenReader reader, string token, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(T token, int at) =>
            new(at, $"Expected {token} to pass predicate.");

        public static Failure<T> ToPass<T>(TokenReader reader, T token, int at, int start) =>
            Undo<T>(reader, at, start, $"Expected {token} to pass predicate.");
