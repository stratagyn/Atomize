...
internal static class Failure
{
    public static class DidNotExpect
    {
        ...
        public static Failure<T> EndOfText<T>(TextScanner scanner, int at, int start) =>
    ...
    public static class Expected
    {
        ...
        public static Failure<T> Char<T>(TextScanner scanner, char parser, int at, int start) =>
            Undo<T>(scanner, at, start, $"Expected to match {{'{parser}'}}.");

        public static Failure<T> Char<T>(TextScanner scanner, char[] parsers, int at, int start) =>
