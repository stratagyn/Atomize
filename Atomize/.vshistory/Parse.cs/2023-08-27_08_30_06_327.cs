...
namespace Atomize.Ext
{
    public static class Parse
    {
        ...
        public static Parser<T> Where<T>(this Parser<T> parser, Predicate<T> test) => 
            Atomize.Parse.Satisfies(parser, test);
    }
}