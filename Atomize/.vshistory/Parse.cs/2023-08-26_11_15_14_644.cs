...
namespace Atomize.Ext
{
    ...
    {
        public static Parser<U> Select<T, U>(this Parser<T> parser, Func<IParseResult<T>, Parser<U>> bind) =>
            Parse.Bind(parser, bind);

        public static Parser<U> SelectMany<T, U>(this Parser<T> parser, Func<T, Parser<U>>)
    }
}