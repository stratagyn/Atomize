...
namespace Atomize.Ext
{
    ...
    {
        public static Parser<U> Select<T, U>(this Parser<T> parser, Func<IParseResult<T>, IParseResult<U>> bind) =>
            (TextScanner scanner) =>
            {
                var at = scanner.Offset;
                var result = parser(scanner);
        ...
        public static Parser<U> SelectMany<T, U>(this Parser<T> parser, Func<IParseResult<T>, IParseResult<U>> bind) =>
            Parse.Bind(parser, bind);
    }
}