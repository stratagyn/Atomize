...
public static partial class Parser
{
    ...
    public static Parser<R> SelectMany<T, U, R>(Parser<T> first, Parser<U> second, Func<T, U, R> map) =>
        (TokenReader reader) =>
        {
    ...
    public static Parser<R> Sequence<T, U, V, R>(Parser<T> first, Parser<U> second, Parser<V> third) =>
        (TokenReader reader) =>
        {
            var at = reader.Offset;
            var firstResult = first(reader);
