...
using ROCParsers = System.Collections.Concurrent.ConcurrentDictionary<string, Atomize.Parser<System.ReadOnlyMemory<char>>>;
using StringParsers = System.Collections.Concurrent.ConcurrentDictionary<string, Atomize.Parser<string>>;

namespace Atomize;

public static partial class Parse
{
    private static readonly CharParsers Chars = new();

    private static readonly CharParsers IChars = new();

    private static readonly ROCParsers Patterns = new();

    private static readonly StringParsers IPatterns = new();

    private static readonly ROCParsers Strings = new();

    private static readonly StringParsers IStrings = new();
