...
public static partial class Parse
{
    ...
    private static readonly ConcurrentDictionary<string, Parser<Characters>> IPatterns =
        new();

    private static readonly ConcurrentDictionary<string, Parser<Characters>> Strings =
        new();

    private static readonly ConcurrentDictionary<string, Parser<Characters>> IStrings =
        new();
