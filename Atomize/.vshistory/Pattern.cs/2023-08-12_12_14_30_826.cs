...
{
    public static partial class Char
    {
    ...
    public static partial class OneOrMore
    {
        public static readonly Regex AlphaNumeric = AlphaNumericRegex();

        public static readonly Regex Any = AnyRegex();

        public static readonly Regex DoubleQuotedString = DoubleQuotedStringRegex();

        public static readonly Regex EscapeSequence = EscapeSequenceRegex();
        ...
        public static readonly Regex QuotedString = QuotedStringRegex();

        public static readonly Regex SingleQuotedString = SingleQuotedStringRegex();

        public static readonly Regex Unicode = UnicodeRegex();
        ...
        [GeneratedRegex(@"(\\u(?:([0-9A-F]{4})|(?:\{((?:10[0-9A-F]{4})|(?:0?[0-9A-F]{5})|(?:[0-9A-F]{1,4}))\})))+")]
