...
public static partial class Parse
{
    ...
    public static Parser<U> If<T, U>(Parser<T> parser,Parser<U> bind, Parser<U> handle) =>
        (TextScanner scanner) =>
        {
            var at = scanner.Offset;
            var result = parser(scanner);
    ...
    public static Parser<(T Trial,IParseResult<U> Fallback)> TryBind<T, U>(Parser<T> parser, Func<T, Parser<U>> bind) =>
        (TextScanner scanner) =>
        {
            var at = scanner.Offset;
