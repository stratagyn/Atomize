...
public static class BasicArithmeticCalculator2
{
    ...
    private static Parser<double> Additive;
    private static Parser<double> Multiplicative;
    private static Parser<double> Exponential;

    public static BasicArithmeticCalculator2()
    {
