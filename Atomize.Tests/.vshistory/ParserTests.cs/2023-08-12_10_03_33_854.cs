...
public static partial class AtomizeTests
{
    ...
    public class UntilTests
    {
        ...
        [Fact]
        public void Until_Matching_Zero_Times_Is_Token()
        {
        ...
        [Fact]
        public void Until_Matching_Zero_Times_AdvancesOffset()
        {
        ...
        [Fact]
        public void Until_Matching_Exactly_Max_Times_Is_Token()
        {
            var actual = Until(1, Literal(Lowercase))(_reader).IsToken;

            Assert.True(actual);
        }

        [Fact]
        public void Until_Matching_Exactly_Max_Times_AdvancesOffset()
        {
            var expected = _reader.Offset + TestOffset;

            _ = Until(TestOffset, Literal(Lowercase))(_reader);
        ...
        [Fact]
        public void Until_Matching_LessThan_Max_Times_Is_Token()
        {
            var actual = Until(27, Literal(Lowercase))(_reader).IsToken;

            Assert.True(actual);
        }

        [Fact]
        public void Until_Matching_LessThan_Max_Times_AdvancesOffset()
        {
            var expected = _reader.Offset + TestOffset;

            _ = Until(27, Literal(Lowercase))(_reader);
        ...
        [Fact]
        public void Until_Matching_Negative_Max_Is_Failure()
        {
            var actual = Until(-1, Literal(Lowercase))(_reader).IsToken;
        ...
        [Fact]
        public void Until_Matching_Negative_Max_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;
