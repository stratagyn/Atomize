...
public static partial class AtomizeTests
{
    ...
    public class PositiveLookAheadTests
    {
        ...
        [Fact]
        public void And_Matching_Character_Is_Token()
        {
        ...
        [Fact]
        public void And_Matching_String_Is_Token()
        {
            var pattern = "abcd";
            var actual = And(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void And_Matching_Regex_Is_Token()
        {
        ...
        [Fact]
        public void And_Matching_Rule_Is_Token()
        {
    ...
    public class NegativeLookAheadTests
    {
        ...
        [Fact]
        public void Not_NonMatching_Character_Is_Token()
        {
            var pattern = '0';
            var actual = Not(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Not_NonMatching_String_Is_Token()
        {
            var pattern = "0123";
            var actual = Not(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Not_NonMatching_Regex_Is_Token()
        {
        ...
        [Fact]
        public void Not_NonMatching_Rule_Is_Token()
        {
            var pattern = Token.String("0123");
            var actual = Not(pattern)(_reader).IsSuccess;
