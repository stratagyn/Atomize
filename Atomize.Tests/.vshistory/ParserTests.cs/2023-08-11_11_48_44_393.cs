...
public static partial class AtomizeTests
{
    ...
    public class NegativeLookAheadTests
    {
        ...
        {
            var actual = Not(Literal("a"), Literal("b"))(_reader).IsToken;
        ...
        public void Not_Matching_Rule_DoesNot_AdvancesOffset()
        {
            ...
            _ = Not(Literal("a"), Literal("b"))(_reader);
        ...
        [Fact]
        public void Not_NonMatching_Rule_AdvancesOffset()
        {
            var expected = _reader.Offset + 1;

            _ = Not(Literal("a"), Literal("B"));
        ...
        [Fact]
        public void Not_NonMatching_Start_Is_Failure()
        {
            var actual = Not(Literal("A"), Literal("B"))(_reader).IsToken;
        ...
        [Fact]
        public void Not_NonMatching_Start_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;
