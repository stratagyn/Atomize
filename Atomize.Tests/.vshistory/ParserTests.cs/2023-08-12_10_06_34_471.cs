...
public static partial class AtomizeTests
{
    ...
    public class MinimumTests
    {
        ...
        [Fact]
        public void Minimum_Matching_GreaterThan_MinTimes_Is_Token()
        {
        ...
        [Fact]
        public void Minimum_Matching_GreaterThan_MinTimes_AdvancesOffset()
        {
            var expected = _reader.Offset + TestOffset;
    ...
    public class NotExactlyTests
    {
        ...
        [Fact]
        public void NotExactly_Matching_Zero_Times_Is_EmptyToken()
        {
            var parsed = NotExactly(0, Literal(Uppercase))(_reader);
        ...
        [Fact]
        public void NotExactly_Matching_Exactly_Min_Times_Is_Token()
        {
        ...
        [Fact]
        public void NotExactly_Matching_Exactly_Min_Times_AdvancesOffset()
        {
            var expected = _reader.Offset + TestOffset;
        ...
        [Fact]
        public void NotExactly_Matching_LessThan_Min_Times_Is_Failure()
        {
            var actual = NotExactly(27, Literal(Lowercase))(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void NotExactly_Matching_LessThan_Min_Times_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;

            _ = NotExactly(27, Literal(Lowercase))(_reader);
        ...
        [Fact]
        public void NotExactly_Matching_GreaterThan_MinTimes_Is_Token()
        {
            var actual = NotExactly(25, Literal(Lowercase))(_reader).IsToken;

            Assert.True(actual);
        }

        [Fact]
        public void NotExactly_Matching_GreaterThan_MinTimes_AdvancesOffset()
        {
            var expected = _reader.Offset + TestOffset;
        ...
        [Fact]
        public void NotExactly_Matching_Negative_Min_Is_Failure()
        {
            var actual = NotExactly(-1, Literal(Lowercase))(_reader).IsToken;
        ...
        [Fact]
        public void NotExactly_Matching_Negative_Min_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;
