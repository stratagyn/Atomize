...
public static partial class AtomizeTests
{
    ...
    public class ChoiceTests
    {
        ...
        {
            var pattern = Array.Empty<Parse<ReadOnlyMemory<char>>>();
        ...
        {
            var pattern = new Parse<ReadOnlyMemory<char>>[] { Token("abcd"), Token("0123"), Token("!@#$") };
            var parsed = Choice(pattern)(_reader);
    ...
    {
        private static readonly Parse<ReadOnlyMemory<char>>[] RuleTokens = new Parse<ReadOnlyMemory<char>>[] {
