...
public static partial class AtomizeTests
{
    ...
    public class FallbackTests
    {
        ...
        {
            var actual = Fallback<char>()(_reader).IsToken;
        ...
        {
            var actual = Fallback(Token.Character('A'))(_reader).IsToken;
    ...
    public class SequenceTests
    {
        ...
        {
            var actual = Sequence(Token.Character('A'))(_reader).IsToken;
    ...
    public class LongestPrefixTests
    {
        ...
        {
            var actual = LongestPrefix()(_reader).IsToken;
        ...
        {
            var actual = LongestPrefix(Token.Character('A'))(_reader).IsToken;
