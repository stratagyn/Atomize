...
public static partial class AtomizeTests
{
    ...
    public class RangeTests
    {
        ...
        [Fact]
        public void Range_Matching_Character_AtLeast_Min_Is_Successful()
        {
            var pattern = 'a';
            var actual = Range(pattern, 0, 1)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Range_Matching_Character_AtLeast_Min_AdvancesOffset()
        {
            var pattern = 'a';
            var expected = _reader.Offset + 1;

            _ = Range(pattern, 1, 26)(in _reader);
        ...
        [Fact]
        public void Range_Matching_Character_LessThan_Min_Is_Failure()
        {
            var pattern = 'a';
            var actual = Range(pattern, 2, 26)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Range_Matching_Character_Negative_Min_Is_Failure()
        {
            var pattern = 'a';
            var actual = Range(pattern, -1, 26)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Range_Matching_Character_Max_LessThan_Min_Is_Failure()
        {
            var pattern = 'a';
            var actual = Range(pattern, 26, 1)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Range_Matching_String_AtLeast_Min_Is_Successful()
        {
            var pattern = "a";
            var actual = Range(pattern, 0, 1)(_reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_String_AtLeast_Min_AdvancesOffset()
        {
            var pattern = "a";
            var expected = _reader.Offset + 1;

            _ = Range(pattern, 0, 1)(in _reader);
        ...
        [Fact]
        public void Range_Matching_String_LessThan_Min_Is_Failure()
        {
            var pattern = "a";
            var actual = Range(pattern, 2, 26)(_reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_String_Negative_Min_Is_Failure()
        {
            var pattern = "a";
            var actual = Range(pattern, -1, 26)(in _reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Range_Matching_String_Max_LessThan_Min_Is_Failure()
        {
            var pattern = "a";
            var actual = Range(pattern, 26, 1)(_reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_Regex_AtLeast_Min_Is_Successful()
        {
        ...
        [Fact]
        public void Range_Matching_Regex_AtLeast_Min_AdvancesOffset()
        {
            var pattern = Character.LowercaseLetter;
            var expected = _reader.Offset + 26;

            _ = Range(pattern, 1, 27)(in _reader);
        ...
        [Fact]
        public void Range_Matching_Regex_LessThan_Min_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Range(pattern, 27, 27)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Range_Matching_Regex_Negative_Min_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Range(pattern, -1, 26)(in _reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_Regex_Max_LessThan_Min_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Range(pattern, 26, 1)(_reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_Rule_Zero_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Range(pattern, 0, 0)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Range_Matching_Rule_AtLeast_Min_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Range(pattern, 1, 26)(_reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_Rule_AtLeast_Min_AdvancesOffset()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var expected = _reader.Offset + 26;
        ...
        [Fact]
        public void Range_Matching_Rule_LessThan_Min_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Range(pattern, 27, 27)(_reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_Rule_Negative_Count_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Range(pattern, -1, 26)(in _reader).IsSuccess;
        ...
        [Fact]
        public void Range_Matching_Rule_Max_LessThan_Min_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Range(pattern, 26, 1)(_reader).IsSuccess;
