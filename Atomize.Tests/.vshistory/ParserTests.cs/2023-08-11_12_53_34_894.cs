...
public static partial class AtomizeTests
{
    ...
    public class MinimumTests
    {
        ...
        [Fact]
        public void Minimum_Matching_Character_Exact_Count_Is_Successful()
        {
            var pattern = 'a';
        ...
        [Fact]
        public void Minimum_Matching_Character_Exact_Count_AdvancesOffset()
        {
            var pattern = 'a';
            var expected = _reader.Offset + 1;

            _ = Minimum(pattern, 1)(IsTokenreader);
        ...
        [Fact]
        public void Minimum_Matching_Character_LessThan_Count_Is_Failure()
        {
            var pattern = 'a';
            var actual = Minimum(pattern, 2)(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Minimum_Matching_Character_MoreThan_Count_Is_Successful()
        {
            var pattern = 'a';
        ...
        [Fact]
        public void Minimum_Matching_Character_Negative_Count_Is_Failure()
        {
            var pattern = 'a';
            var actual = Minimum(pattern, -1)(_reader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_String_Exact_Count_Is_Successful()
        {
            var pattern = "a";
            var actual = Minimum(pattern, 1)(_reader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_String_Exact_Count_AdvancesOffset()
        {
            var pattern = "a";
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void Minimum_Matching_String_LessThan_Count_Is_Failure()
        {
            var pattern = "a";
            var actual = Minimum(pattern, 2)(_reader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_String_MoreThan_Count_Is_Successful()
        {
            var pattern = "a";
            var actual = Minimum(pattern, 0)(_reader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_String_Negative_Count_Is_Failure()
        {
            var pattern = "a";
            var actual = Minimum(pattern, -1)(IsTokenreader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Minimum_Matching_Regex_Exact_Count_Is_Successful()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Minimum(pattern, 26)(_reader).IsToken;

            Assert.True(actual);
        }

        [Fact]
        public void Minimum_Matching_Regex_Exact_Count_AdvancesOffset()
        {
            var pattern = Character.LowercaseLetter;
            var expected = _reader.Offset + 26;
        ...
        [Fact]
        public void Minimum_Matching_Regex_LessThan_Count_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
        ...
        [Fact]
        public void Minimum_Matching_Regex_MoreThan_Count_Is_Successful()
        {
            var pattern = Character.LowercaseLetter;
        ...
        [Fact]
        public void Minimum_Matching_Regex_Negative_Count_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Minimum(pattern, -1)(IsTokenreader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_Rule_Zero_Is_Successful()
        {
        ...
        [Fact]
        public void Minimum_Matching_Rule_Exact_Count_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Minimum(pattern, 1)(_reader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_Rule_Exact_Count_AdvancesOffset()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var expected = _reader.Offset + 26;

            _ = Minimum(pattern, 26)(IsTokenreader);
        ...
        [Fact]
        public void Minimum_Matching_Rule_LessThan_Count_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Minimum(pattern, 27)(_reader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_Rule_MoreThan_Count_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Minimum(pattern, 25)(_reader).IsToken;
        ...
        [Fact]
        public void Minimum_Matching_Rule_Negative_Count_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Minimum(pattern, -1)(IsTokenreader).IsToken;
