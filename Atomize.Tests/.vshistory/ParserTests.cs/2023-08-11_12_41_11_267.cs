...
public static partial class AtomizeTests
{
    ...
    public class SatisfiesTests
    {
        ...
        [Fact]
        public void Satisfies_Matching_Fails_Rule_Test_D()
        {
            var actual = Satisfies(Literal('a'), CharIsB)(_reader).IsToken;
        ...
        public void Satisfies_NonMatching_Rule_Is_Failure()
        {
            ...
            var actual = Satisfies(pattern, ObjIsA)(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_Passes_Rule_Test_Matching_Predicate_Is_Token()
        {
        ...
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Satisfies(pattern, CharIsB)(_reader).IsToken;
        ...
        {
            var pattern = Token.Character(Character.UppercaseLetter);
            var actual = Satisfies(pattern, CharIsA)(_reader).IsToken;
        ...
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Satisfies(pattern, StrIsA)(_reader).IsToken;
