...
public static partial class AtomizeTests
{
    ...
    public class IgnoreCharTests
    {
        ...
        public IgnoreCharTests() => _reader = new Scanner(TestText);
    ...
    public class IgnoreStringTests
    {
        ...
        public IgnoreStringTests() => _reader = new Scanner(TestText);
    ...
    public class IgnoreRegexTests
    {
        ...
        public IgnoreRegexTests() => _reader = new Scanner(TestText);
