...
public static partial class AtomizeTests
{
    ...
    public class PositiveLookAheadTests
    {
        ...
        [Fact]
        public void IfFollowedBy_Matching_Rule_DoesNot_AdvancesOffset()
        {
        ...
        [Fact]
        public void IfFollowedBy_NonMatching_Rule_DoesNot_AdvancesOffset()
        {
            var expected = _reader.Offset;

            _ = IfFollowedBy(Literal("a"), Literal("B"))(in _reader);
        ...
        [Fact]
        public void IfFollowedBy_NonMatching_Start_DoesNot_AdvancesOffset()
        {
            var expected = _reader.Offset;
