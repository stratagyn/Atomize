...
public static partial class AtomizeTests
{
    ...
    public class MapTests
    {
        ...
        {
            var parser = Map(Token('a'), a => Succeed(a));
        ...
        [Fact]
        public void Map_Match_NoRead_Is_Token()
        {
            var parser = Map(Ignore('a'), a => Succeed(a));
        ...
        [Fact]
        public void Map_Match_NoRead_AdvancesOffset()
        {
            var parser = Map(Ignore('a'), a => Succeed(a));
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void Map_Match_ReadFirstMatchOnly_Is_Token()
        {
            var parser = Map(Token('a'), a => Map(Ignore('b'), _ => Succeed(a)));
            var parse = parser(_reader);
            var actual = parse.IsToken;
        ...
        [Fact]
        public void Map_Match_ReadFirstMatchOnly_AdvancesOffset()
        {
            var parser = Map(Token('a'), a => Map(Ignore('b'), _ => Succeed(a)));
            var expected = _reader.Offset + 2;
        ...
        [Fact]
        public void Map_StartingWith_NonMatch_Is_Failure()
        {
            var actual = Map(Token('A'), a => Succeed(a))(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Map_StartingWith_NonMatch_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;

            _ = Map(Token('A'), a => Succeed(a))(_reader);
        ...
        [Fact]
        public void Map_NonMatch_AfterMatch_Is_Failure()
        {
            var parser = Map(Token('a'), a => Map(Token('B'), _ => Succeed(a)));
            var actual = parser(_reader).IsToken;
