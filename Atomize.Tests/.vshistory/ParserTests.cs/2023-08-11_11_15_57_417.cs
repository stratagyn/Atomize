...
public static partial class AtomizeTests
{
    ...
    {
        [Fact]
        public void Split_Character_MatchingRules_Is_Successful()
        {
            var reader = new TokenReader("abba abba abba abba");
            var parse = Split(' ', Token.String("abba"))(reader);
        ...
        [Fact]
        public void Split_Character_MatchingRules_Advances_Offset()
        {
            var reader = new TokenReader("abba abba abba abba");
            var expected = reader.Offset + 19;
            _ = Split(' ', Token.String("abba"))(reader);
            var actual = reader.Offset;
        ...
        [Fact]
        public void Split_Character_NonMatchingRule_Is_Successful()
        {
        ...
        [Fact]
        public void Split_Character_StartingWith_NonMatchingRule_Is_Failure()
        {
        ...
        [Fact]
        public void Split_Character_NonMatchingSeparator_Character_Is_Successful()
        {
        ...
        [Fact]
        public void Split_String_MatchingRules_Is_Successful()
        {
            var reader = new TokenReader("abba abba abba abba");
            var parse = Split(" ", Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_String_MatchingRules_Advances_Offset()
        {
            var reader = new TokenReader("abba abba abba abba");
            var expected = reader.Offset + 19;
            _ = Split(" ", Token.String("abba"))(reader);
        ...
        [Fact]
        public void Split_String_NonMatchingRule_Is_Successful()
        {
            var reader = new TokenReader("abba baab abba abba");
            var parse = Split(" ", Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_String_StartingWith_NonMatchingRule_Is_Failure()
        {
            var reader = new TokenReader("baab abba abba abba");
            var parse = Split(" ", Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_String_NonMatchingSeparator_String_Is_Successful()
        {
            var reader = new TokenReader("abbaabbaabbaabba");
            var parse = Split(" ", Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_Regex_MatchingRules_Is_Successful()
        {
            var reader = new TokenReader("abba abba abba abba");
            var parse = Split(Character.Whitespace, Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_Regex_MatchingRules_Advances_Offset()
        {
            var reader = new TokenReader("abba abba abba abba");
            var expected = reader.Offset + 19;
            _ = Split(Character.Whitespace, Token.String("abba"))(reader);
            var actual = reader.Offset;
        ...
        [Fact]
        public void Split_Regex_NonMatchingRule_Is_Successful()
        {
            var reader = new TokenReader("abba baab abba abba");
            var parse = Split(Character.Whitespace, Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_Regex_StartingWith_NonMatchingRule_Is_Failure()
        {
            var reader = new TokenReader("baab abba abba abba");
            var parse = Split(Character.Whitespace, Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_Regex_NonMatchingSeparator_Regex_Is_Successful()
        {
            var reader = new TokenReader("abbaabbaabbaabba");
            var parse = Split(Character.Whitespace, Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_Rule_MatchingRules_Is_Successful()
        {
            var reader = new TokenReader("abba abba abba abba");
            var parse = Split(Token.Character(' '), Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        public void Split_Rule_MatchingRules_Advances_Offset()
        {
            var reader = new TokenReader("abba abba abba abba");
            var expected = reader.Offset + 19;
            _ = Split(Token.Character(' '), Token.String("abba"))(reader);
            var actual = reader.Offset;
        ...
        [Fact]
        public void Split_Rule_NonMatchingRule_Is_Successful()
        {
            var reader = new TokenReader("abba baab abba abba");
            var parse = Split(Token.Character(' '), Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Split_Rule_NonMatchingSeparator_Rule_Is_Successful()
        {
            var reader = new TokenReader("abbaabbaabbaabba");
            var parse = Split(Token.Character(' '), Token.String("abba"))(reader);
            var actual = parse.IsSuccess;
