...
public static partial class AtomizeTests
{
    ...
    public class LiteralTests
    {
        ...
        [Fact]
        public void Literal_Matching_String_DoesNotFollowedBy_AdvanceOffset()
        {
            var expected = _reader.Offset + 4;
        ...
        [Fact]
        public void Literal_NonMatching_Is_Failure()
        {
            var pattern = Literal("0123");
            var actual = Literal(pattern)(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Literal_NonMatching_DoesNotFollowedBy_AdvanceOffset()
        {
            var pattern = Literal("0123");
            var expected = _reader.Offset;

            _ = Literal(pattern)(_reader);
