...
public static partial class AtomizeTests
{
    ...
    public class IfTests
    {
        ...
        [Fact]
        public void If_True_Is_True_Atom()
        {
            var parser = If(Atom('a'), Text.LowercaseLetter, Empty<ReadOnlyMemory<char>>);
            var expected = "abcdefghijklmnopqrstuvwxyz".AsMemory();
            var actual = parser(_reader).Value;

            Assert.Tru(expected.Span.Equals(actual.Span, StringComparison.Ordinal));
        }

        [Fact]
        public void If_True_AdvancesOffset()
        {
            var parser = If(Atom('a'), Text.LowercaseLetter, Empty<ReadOnlyMemory<char>>);
        ...
        {
            var parser = If(Atom('A'), Text.UppercaseLetter, Text.Number);
        ...
        public void If_False_NonMatch_DoesNot_AdvanceOffset()
        {
            ...
            _ = If(Atom('A'), Text.UppercaseLetter, Text.Number);
        ...
        [Fact]
        public void If_False_Match_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;
