...
public static partial class AtomizeTests
{
    ...
    public class FallbackTests
    {
        ...
        [Fact]
        public void Fallback_Empty_Is_Successful()
        {
            var actual = Fallback()(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Fallback_Match_Is_Successful()
        {
        ...
        [Fact]
        public void Fallback_Match_NoRead_Is_Successful()
        {
            var sequence = Fallback(
                Consume('a'),
                Consume('b'),
        ...
        [Fact]
        public void Fallback_Match_ReadFirstMatchOnly_Is_Successful()
        {
            var sequence = Fallback(
                Token.Character('a'),
                Consume('b'),
        ...
        {
            var actual = Fallback(Token.Character('A'))(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Fallback_NonMatch_Is_Successful()
        {
            var sequence = Fallback(
                Token.Character('a'),
                Token.Character('0'));
        ...
        [Fact]
        public void Fallback_NonMatch_AdvancesOffset_ByFirstMatch()
        {
