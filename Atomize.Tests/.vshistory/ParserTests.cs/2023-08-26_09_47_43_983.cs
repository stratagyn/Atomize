...
public static partial class AtomizeTests
{
    ...
    public class ChoiceTests
    {
        ...
        [Fact]
        public void Choice_Matching_Is_Token()
        {
    ...
    public class ExactlyTests
    {
        ...
        {
            var parsed = Exactly(0, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var parsed = Exactly(TestOffset, Pattern.Char.LowercaseLetter)(_reader);
        ...
        public void Exactly_Matching_Exact_Count_AdvancesOffset()
        {
            ...
            var _ = Exactly(TestOffset, Pattern.Char.LowercaseLetter)(_reader);
            var actual = _reader.Offset;
        ...
        {
            var parsed = Exactly(TestOffset + 1, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var expected = _reader.Offset;
            var _ = Exactly(TestOffset + 1, Pattern.Char.LowercaseLetter)(_reader);
            var actual = _reader.Offset;
        ...
        {
            var parsed = Exactly(-1, Pattern.Char.LowercaseLetter)(_reader);
    ...
    public class HandleTests
    {
        ...
        public void Handle_NonMatch_To_Match_Does_AdvanceOffset()
        {
            ...
            _ = Handle(Token('A'), err => Token('a'))(_reader);
    ...
    public class PositiveLookBehindTests
    {
        ...
        public void IfPrecededBy_Matching_Is_Token()
        {
            ...
            var actual = IfPrecededBy(Token("0123"), Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void IfPrecededBy_Matching_AdvancesOffset()
        {
            ...
            _ = IfPrecededBy(Token("0123"), Pattern.Char.LowercaseLetter)(_reader);
        ...
        public void IfPrecededBy_NonMatching_Is_Failure()
        {
            ...
            var actual = IfPrecededBy(Token("0123"), Pattern.Char.UppercaseLetter)(_reader).IsToken;
        ...
        public void IfPrecededBy_NonMatching_DoesNot_AdvanceOffset()
        {
            ...
            _ = IfPrecededBy(Token("0123"), Pattern.Char.UppercaseLetter)(_reader);
    ...
    public class MapTests
    {
        ...
        public void Map_NonMatch_DoesNot_AdvanceOffset()
        {
            ...
            _ = Map(Token('a'), a => Map(Token('A'), a => (int)a));
    ...
    public class MaximumTests
    {
        ...
        {
            var parsed = Maximum(0, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = Maximum(1, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Maximum_Matching_Exactly_Max_Times_AdvancesOffset()
        {
            ...
            _ = Maximum(TestOffset, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = Maximum(27, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Maximum_Matching_LessThan_Max_Times_AdvancesOffset()
        {
            ...
            _ = Maximum(27, Pattern.Char.LowercaseLetter)(_reader);
        ...
        public void Maximum_Matching_Negative_Max_DoesNot_AdvanceOffset()
        {
            ...
            _ = Minimum(-1, Pattern.Char.LowercaseLetter)(_reader);
    ...
    public class MinimumTests
    {
        ...
        {
            var parsed = Minimum(0, Pattern.Char.UppercaseLetter)(_reader);
        ...
        {
            var actual = Minimum(1, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Minimum_Matching_Exactly_Min_Times_AdvancesOffset()
        {
            ...
            _ = Minimum(TestOffset, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = Minimum(27, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Minimum_Matching_LessThan_Min_Times_DoesNot_AdvanceOffset()
        {
            ...
            _ = Minimum(27, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = Minimum(25, Pattern.Char.LowercaseLetter)(_reader).IsToken;
    ...
    public class NegativeLookBehindTests
    {
        ...
        public void NotPrecededBy_Matching_Is_Failure()
        {
            ...
            var actual = NotPrecededBy(Token("0123"), Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void NotPrecededBy_Matching_DoesNot_AdvanceOffset()
        {
            ...
            _ = NotPrecededBy(Token("0123"), Pattern.Char.LowercaseLetter)(_reader);
        ...
        public void NotPrecededBy_NonMatching_Is_Token()
        {
            ...
            var actual = NotPrecededBy(Token("0123"), Pattern.Char.UppercaseLetter)(_reader).IsToken;
        ...
        public void NotPrecededBy_NonMatching_AdvancesOffset()
        {
            ...
            _ = NotPrecededBy(Token("0123"), Pattern.Char.UppercaseLetter)(_reader);
        ...
        public void NotPrecededBy_NonMatching_Start_DoesNotPrecededBy_AdvanceOffset()
        {
            ...
            _ = NotPrecededBy(Token("0123"), Pattern.Char.LowercaseLetter);
    ...
    public class NotExactlyTests
    {
        ...
        {
            var actual = NotExactly(TestOffset, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void NotExactly_Matching_Exactly_N_Times_DoesNot_AdvanceOffset()
        {
            ...
            _ = NotExactly(TestOffset, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = NotExactly(1, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void NotExactly_Matching_GreaterThan_N_Times_AdvancesOffset()
        {
            ...
            _ = NotExactly(1, Pattern.Char.LowercaseLetter)(_reader);
        ...
        public void NotExactly_Full_Match_Is_Token()
        {
            ...
            var actual = NotExactly(1, Pattern.Char.LowercaseLetter)(reader).IsToken;
        ...
        public void NotExactly_Full_Match_AdvancesOffset()
        {
            ...
            _ = NotExactly(1, Pattern.Char.LowercaseLetter)(reader);
    ...
    public class OptionalTests
    {
        ...
        {
            var actual = Optional(Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Optional_Matching_AdvancesOffset()
        {
            ...
            _ = Optional(Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = Optional(Pattern.Char.UppercaseLetter)(_reader).IsToken;
        ...
        public void Optional_NonMatching_DoesNot_AdvanceOffset()
        {
            ...
            _ = Optional(Pattern.Char.UppercaseLetter)(_reader);
    ...
    public class RangeTests
    {
        ...
        {
            var actual = Range(0, 0, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        {
            var actual = Range(1, 26, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Range_Matching_AtLeast_Min_Times_AdvancesOffset()
        {
            ...
            _ = Range(1, 27, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = Range(27, 27, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Range_Matching_LessThan_Min_Times_DoesNot_AdvanceOffset()
        {
            ...
            _ = Range(27, 27, Pattern.Char.LowercaseLetter)(_reader);
        ...
        public void Range_Matching_Negative_Count_DoesNot_AdvanceOffset()
        {
            ...
            _ = Range(-1, 26, Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var actual = Range(26, 1, Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void Range_Matching_Max_LessThan_Min_DoesNot_AdvanceOffset()
        {
            ...
            _ = Range(26, 1, Pattern.Char.LowercaseLetter)(_reader);
    ...
    public class TokenTests
    {
        ...
        {
            var actual = Pattern.Char.LowercaseLetter(_reader).IsToken;
        ...
        public void Token_Matching_Regex_AdvancesOffset()
        {
            ...
            _ = Pattern.Char.LowercaseLetter(_reader);
        ...
        {
            var actual = Pattern.Char.UppercaseLetter(_reader).IsToken;
        ...
        public void Token_NonMatching_Regex_DoesNot_AdvanceOffset()
        {
            ...
            _ = Pattern.Char.UppercaseLetter(_reader);
    ...
    public class ZeroOrMoreTests
    {
        ...
        {
            var actual = ZeroOrMore(Pattern.Char.UppercaseLetter)(_reader).IsToken;
        ...
        public void ZeroOrMore_Matching_Zero_Times_DoesNot_AdvanceOffset()
        {
            ...
            _ = ZeroOrMore(Pattern.Char.UppercaseLetter)(_reader);
        ...
        {
            var actual = ZeroOrMore(Pattern.Char.LowercaseLetter)(_reader).IsToken;
        ...
        public void ZeroOrMore_Matching_GreaterThan_Zero_Times_AdvancesOffset()
        {
            ...
            _ = ZeroOrMore(Pattern.Char.LowercaseLetter)(_reader);
        ...
        {
            var reader = new TextScanner(TestText[0..TestOffset]);
            var actual = ZeroOrMore(Pattern.Char.LowercaseLetter)(reader).IsToken;
        ...
        public void ZeroOrMore_FullMatch_AdvancesOffset()
        {
            ...
            _ = ZeroOrMore(Pattern.Char.LowercaseLetter)(reader);
