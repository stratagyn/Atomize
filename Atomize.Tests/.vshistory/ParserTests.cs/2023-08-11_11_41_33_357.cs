...
public static partial class AtomizeTests
{
    ...
    public class PositiveLookAheadTests
    {
        ...
        {
            var actual = And(Literal("a"), Literal("b"))(_reader).IsToken;
        ...
        public void And_Matching_Rule_DoesNot_AdvancesOffset()
        {
            ...
            _ = And(Literal("a"), Literal("b"))(_reader);
        ...
        public void And_NonMatching_Rule_DoesNot_AdvancesOffset()
        {
            ...
            _ = And(Literal("a"), Literal("B"))(in _reader);
        ...
        [Fact]
        public void And_NonMatching_Start_Is_Failure()
        {
            var actual = And(Literal("A"), Literal("b"))(_reader).IsToken;
        ...
        [Fact]
        public void And_NonMatching_Start_DoesNot_AdvancesOffset()
        {
            var expected = _reader.Offset;
    ...
    public class NegativeLookAheadTests
    {
        ...
        {
            var pattern = 'a';
            var actual = Not(pattern)(_reader).IsToken;
        ...
        {
            var actual = Not(Text.LowercaseLetter)(_reader).IsToken;
        ...
        {
            var actual = Not(Text.Number)(_reader).IsToken;
