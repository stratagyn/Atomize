...
public static partial class AtomizeTests
{
    ...
    public class ExactlyTests
    {
        ...
        [Fact]
        public void Exactly_Matching_Character_Zero_Is_Successful()
        {
            var pattern = 'a';
            var actual = Exactly(pattern, 0)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Exactly_Matching_Character_Exact_Count_Is_Successful()
        {
            var pattern = 'a';
            var actual = Exactly(pattern, 1)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Exactly_Matching_Character_Exact_Count_AdvancesOffset()
        {
            var pattern = 'a';
            var expected = _reader.Offset + 1;

            _ = Exactly(pattern, 1)(in _reader);
        ...
        [Fact]
        public void Exactly_Matching_Character_LessThan_Count_Is_Failure()
        {
            var pattern = 'a';
            var actual = Exactly(pattern, 2)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Exactly_Matching_Character_Negative_Count_Is_Failure()
        {
            var pattern = 'a';
            var actual = Exactly(pattern, -1)(_reader).IsSuccess;
        ...
        [Fact]
        public void Exactly_Matching_String_Zero_Is_Successful()
        {
            var pattern = "a";
            var actual = Exactly(pattern, 0)(_reader).IsSuccess;
        ...
        [Fact]
        public void Exactly_Matching_String_Exact_Count_Is_Successful()
        {
            var pattern = "a";
            var actual = Exactly(pattern, 1)(_reader).IsSuccess;
        ...
        [Fact]
        public void Exactly_Matching_String_Exact_Count_AdvancesOffset()
        {
            var pattern = "a";
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void Exactly_Matching_String_LessThan_Count_Is_Failure()
        {
            var pattern = "a";
            var actual = Exactly(pattern, 2)(_reader).IsSuccess;
        ...
        [Fact]
        public void Exactly_Matching_String_Negative_Count_Is_Failure()
        {
            var pattern = "a";
            var actual = Exactly(pattern, -1)(_reader).IsSuccess;
        ...
        [Fact]
        public void Exactly_Matching_Regex_Zero_Is_Successful()
        {
        ...
        [Fact]
        public void Exactly_Matching_Regex_Exact_Count_Is_Successful()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Exactly(pattern, 26)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Exactly_Matching_Regex_Exact_Count_AdvancesOffset()
        {
            var pattern = Character.LowercaseLetter;
            var expected = _reader.Offset + 26;

            _ = Exactly(pattern, 26)(in _reader);
        ...
        [Fact]
        public void Exactly_Matching_Regex_LessThan_Count_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Exactly(pattern, 27)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Exactly_Matching_Regex_Negative_Count_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Exactly(pattern, -1)(_reader).IsSuccess;
        ...
        [Fact]
        public void Exactly_Matching_Rule_Zero_Is_Successful()
        {
        ...
        [Fact]
        public void Exactly_Matching_Rule_Exact_Count_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Exactly(pattern, 1)(_reader).IsSuccess;
