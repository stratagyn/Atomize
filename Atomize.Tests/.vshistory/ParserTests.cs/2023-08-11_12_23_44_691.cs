...
public static partial class AtomizeTests
{
    ...
    public class FallbackTests
    {
        ...
        [Fact]
        public void Fallback_NonMatch_Is_Token()
        {
            var sequence = Fallback(
                Literal('a'),
                Literal('0'));
    ...
    public class Ignore<char>Tests
    {
        private readonly TokenReader _reader;

        public Ignore<char>Tests() => _reader = new TokenReader(TestText);

        [Fact]
        public void Ignore<char>_Matching_Rule_Is_Token()
        {
        ...
        [Fact]
        public void Ignore<char>_Matching_Rule_DoesNotFollowedBy_AdvanceOffset()
        {
            var pattern = Literal("abcd");
            var expected = _reader.Offset + 4;
        ...
        [Fact]
        public void Ignore<char>_NonMatching_Rule_Is_Failure()
        {
        ...
        [Fact]
        public void Ignore<char>_NonMatching_Rule_DoesNotFollowedBy_AdvanceOffset()
        {
            var pattern = Literal("0123");
            var expected = _reader.Offset;
    ...
    public class LongestPrefixTests
    {
        ...
        [Fact]
        public void LongestPrefix_Empty_Is_Token()
        {
