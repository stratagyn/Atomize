...
public static partial class AtomizeTests
{
    ...
    public class PositiveLookBehindTests
    {
        ...
        [Fact]
        public void IfPrecededBy_OverMatching_NonMatching_Short_Is_Failure()
        {
            _reader.Advance(TestOffset);

            var actual = IfPrecededBy(
                Bind(Character.LowercaseLetter, _ => Character.Digit),
                Character.UppercaseLetter)(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void IfPrecededBy_OverMatching_NonMatching_Short_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;
    ...
    public class NegativeLookBehindTests
    {
        ...
        [Fact]
        public void NotPrecededBy_OverMatching_NonMatching_Short_Is_Failure()
        {
            _reader.Advance(TestOffset);
