...
public static partial class AtomizeTests
{
    ...
    {
        private static readonly Converter<char, int> Char2Int = c => c;
        private static readonly Converter<string, int> Str2Int = s => s[0];
        private static readonly Converter<object?, int> Obj2Int = o => o?.ToString()?[0] ?? -1;
        ...
        [Fact]
        public void Map_Matching_Character_Is_Successful()
        {
            var pattern = 'a';
            var expected = (int)pattern;
        ...
        [Fact]
        public void Map_Matching_Character_AdvancesOffset()
        {
            var pattern = 'a';
        ...
        [Fact]
        public void Map_NonMatching_Character_Is_Failure()
        {
            var pattern = 'b';
            var actual = Map(pattern, Char2Int)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Map_Matching_String_Is_Successful()
        {
            var pattern = "a";
            var expected = (int)'a';

            var parse = Map(pattern, Str2Int)(_reader);
            var success = parse.IsSuccess;
        ...
        [Fact]
        public void Map_Matching_String_AdvancesOffset()
        {
            var pattern = "a";
            var expected = _reader.Offset + 1;

            _ = Map(pattern, Str2Int)(_reader);
            var actual = _reader.Offset;
        ...
        [Fact]
        public void Map_NonMatching_String_Is_Failure()
        {
            var pattern = "b";
            var actual = Map(pattern, Str2Int)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Map_Matching_Regex_Is_Successful()
        {
        ...
        [Fact]
        public void Map_Matching_Regex_AdvancesOffset()
        {
            var pattern = Character.LowercaseLetter;
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void Map_NonMatching_Regex_Is_Failure()
        {
        ...
        [Fact]
        public void Map_Matching_Rule_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var expected = (int)'a';

            var parse = Map(pattern, Obj2Int)(_reader);
            var success = parse.IsSuccess;
        ...
        public void Map_NonMatching_Rule_Is_Failure()
        {
            ...
            var actual = Map(pattern, Obj2Int)(_reader).IsSuccess;
