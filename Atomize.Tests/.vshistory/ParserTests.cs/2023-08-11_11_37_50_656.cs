...
public static partial class AtomizeTests
{
    ...
    public class PositiveLookAheadTests
    {
        ...
        [Fact]
        public void And_Matching_Character_Is_Successful()
        {
            var pattern = 'a';
            var actual = And(pattern)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void And_Matching_Character_DoesNot_AdvancesOffset()
        {
            var pattern = 'a';
            var expected = _reader.Offset;

            _ = And(pattern)(in _reader);
        ...
        [Fact]
        public void And_NonMatching_Character_Is_Failure()
        {
            var pattern = '0';
            var actual = And(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void And_NonMatching_Character_DoesNot_AdvancesOffset()
        {
            var pattern = '0';
            var expected = _reader.Offset;
        ...
        [Fact]
        public void And_Matching_String_Is_Successful()
        {
            var pattern = "abcd";
            var actual = And(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void And_Matching_String_DoesNot_AdvancesOffset()
        {
            var pattern = "abcd";
            var expected = _reader.Offset;
        ...
        [Fact]
        public void And_NonMatching_String_Is_Failure()
        {
            var pattern = "0123";
            var actual = And(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void And_NonMatching_String_DoesNot_AdvancesOffset()
        {
            var pattern = "0123";
            var expected = _reader.Offset;
        ...
        [Fact]
        public void And_Matching_Regex_Is_Successful()
        {
            var actual = And(Text.LowercaseLetter)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void And_Matching_Regex_DoesNot_AdvancesOffset()
        {
            var expected = _reader.Offset;

            _ = And(Text.LowercaseLetter)(in _reader);
        ...
        [Fact]
        public void And_NonMatching_Regex_Is_Failure()
        {
            var actual = And(Text.Number)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void And_NonMatching_Regex_DoesNot_AdvancesOffset()
        {
            var expected = _reader.Offset;

            _ = Choice(Text.Number)(in _reader);
        ...
        [Fact]
        public void And_Matching_Rule_Is_Successful()
        {
        ...
        [Fact]
        public void And_Matching_Rule_DoesNot_AdvancesOffset()
        {
            var pattern = Token.String("abcd");
            var expected = _reader.Offset;
        ...
        [Fact]
        public void And_NonMatching_Rule_Is_Failure()
        {
        ...
        [Fact]
        public void And_NonMatching_Rule_DoesNot_AdvancesOffset()
        {
            var pattern = Token.String("0123");
            var expected = _reader.Offset;
    ...
    public class NegativeLookAheadTests
    {
        ...
        [Fact]
        public void Not_Matching_Character_Is_Failure()
        {
            var pattern = 'a';
            var actual = Not(pattern)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Not_Matching_Character_DoesNot_AdvancesOffset()
        {
            var pattern = 'a';
            var expected = _reader.Offset;

            _ = Not(pattern)(in _reader);
        ...
        [Fact]
        public void Not_NonMatching_Character_Is_Successful()
        {
            var pattern = '0';
            var actual = Not(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Not_NonMatching_Character_DoesNot_AdvancesOffset()
        {
            var pattern = '0';
            var expected = _reader.Offset;
        ...
        [Fact]
        public void Not_Matching_String_Is_Failure()
        {
            var pattern = "abcd";
            var actual = Not(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Not_Matching_String_DoesNot_AdvancesOffset()
        {
            var pattern = "abcd";
            var expected = _reader.Offset;
        ...
        [Fact]
        public void Not_NonMatching_String_Is_Successful()
        {
            var pattern = "0123";
            var actual = Not(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Not_NonMatching_String_DoesNot_AdvancesOffset()
        {
            var pattern = "0123";
            var expected = _reader.Offset;
        ...
        [Fact]
        public void Not_Matching_Regex_Is_Failure()
        {
            var actual = Not(Text.LowercaseLetter)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Not_Matching_Regex_DoesNot_AdvancesOffset()
        {
            var expected = _reader.Offset;

            _ = Not(Text.LowercaseLetter)(in _reader);
        ...
        [Fact]
        public void Not_NonMatching_Regex_Is_Successful()
        {
            var actual = Not(Text.Number)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Not_NonMatching_Regex_DoesNot_AdvancesOffset()
        {
            var expected = _reader.Offset;

            _ = Not(Text.Number)(in _reader);
        ...
        [Fact]
        public void Not_Matching_Rule_Is_Failure()
        {
            var pattern = Token.String("abcd");
            var actual = Not(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Not_Matching_Rule_DoesNot_AdvancesOffset()
        {
            var pattern = Token.String("abcd");
            var expected = _reader.Offset;
        ...
        [Fact]
        public void Not_NonMatching_Rule_Is_Successful()
        {
            var pattern = Token.String("0123");
            var actual = Not(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Not_NonMatching_Rule_DoesNot_AdvancesOffset()
        {
            var pattern = Token.String("0123");
            var expected = _reader.Offset;
