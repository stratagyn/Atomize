...
public static partial class AtomizeTests
{
    public class BindTests
    {
        ...
        {
            var actual = Bind(Atom('A'), a => Succeed(a))(_reader).IsToken;
    ...
    public class HandleTests
    {
        ...
        {
            var parser = Handle(Atom('a'), err => Succeed(new EmptyToken<char>(err.Offset)));
            var expected = 'a';
        ...
        public void Handle_NonMatch_To_Empty_Token_DoesNot_AdvanceOffset()
        {
            ...
            _ = Handle(Atom('A'), err => Succeed(new EmptyToken<char>(err.Offset)))(_reader);
    ...
    public class PositiveLookBehindTests
    {
        ...
        public void IfPrecededBy_Matching_Is_Token()
        {
            ...
            var actual = IfPrecededBy(Token("0123"), Parse.Character.LowercaseLetter)(_reader).IsToken;
        ...
        public void IfPrecededBy_Matching_AdvancesOffset()
        {
            ...
            _ = IfPrecededBy(Token("0123"), Parse.Character.LowercaseLetter)(_reader);
        ...
        public void IfPrecededBy_NonMatching_Is_Failure()
        {
            ...
            var actual = IfPrecededBy(Token("0123"), Parse.Character.UppercaseLetter)(_reader).IsToken;
        ...
        public void IfPrecededBy_NonMatching_DoesNot_AdvanceOffset()
        {
            ...
            _ = IfPrecededBy(Token("0123"), Parse.Character.UppercaseLetter)(_reader);
    ...
    public class NegativeLookBehindTests
    {
        ...
        public void NotPrecededBy_Matching_Is_Failure()
        {
            ...
            var actual = NotPrecededBy(Token("0123"), Parse.Character.LowercaseLetter)(_reader).IsToken;
        ...
        public void NotPrecededBy_Matching_DoesNot_AdvanceOffset()
        {
            ...
            _ = NotPrecededBy(Token("0123"), Parse.Character.LowercaseLetter)(_reader);
        ...
        public void NotPrecededBy_NonMatching_Is_Token()
        {
            ...
            var actual = NotPrecededBy(Token("0123"), Parse.Character.UppercaseLetter)(_reader).IsToken;
        ...
        public void NotPrecededBy_NonMatching_AdvancesOffset()
        {
            ...
            _ = NotPrecededBy(Token("0123"), Parse.Character.UppercaseLetter)(_reader);
        ...
        public void NotPrecededBy_NonMatching_Start_DoesNotPrecededBy_AdvanceOffset()
        {
            ...
            _ = NotPrecededBy(Token("0123"), Parse.Character.LowercaseLetter);
