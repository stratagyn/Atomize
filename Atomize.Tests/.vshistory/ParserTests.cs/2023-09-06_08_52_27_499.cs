...
public static partial class AtomizeTests
{
    public class BindTests
    {
        ...
        public void Bind_Match_Is_Atom()
        {
            ...
            var actual = parser(_reader).IsAtom;
        ...
        {
            var actual = Bind(Atom('A'), a => Succeed(a))(_reader).IsAtom;
        ...
        public void Bind_StartingWith_NonMatch_DoesNot_AdvanceOffset()
        {
            ...
            _ = Bind(Atom('A'), a => Succeed(a))(_reader);
    ...
    public class EndOfTextTests
    {
        ...
        [Fact]
        public void EOT_AtEnd_Is_EmptyAtom()
        {
        ...
        {
            var actual = EndOfText(_reader).IsAtom;
            Assert.False(actual);
        }
    ...
    public class ExactlyTests
    {
        ...
        [Fact]
        public void Exactly_Matching_Zero_Times_Is_EmptyAtom()
        {
    ...
    public class HandleTests
    {
        ...
        {
            var parser = Handle(Atom('a'), err => Succeed(new EmptyAtom<char>(err.Offset)));
            var expected = 'a';
        ...
        public void Handle_NonMatch_To_Empty_Atom_DoesNot_AdvanceOffset()
        {
            ...
            _ = Handle(Atom('A'), err => Succeed(new EmptyAtom<char>(err.Offset)))(_reader);
    ...
    public class IgnoreCharTests
    {
        ...
        {
            var pattern = 'a';
            var actual = Ignore(pattern)(_reader).IsAtom;
    ...
    public class IgnoreRegexTests
    {
        ...
        public void Ignore_Matching_Is_Atom()
        {
            var pattern = Parse.Character.LowercaseLetter;
            var actual = Ignore(pattern)(_reader).IsAtom;
        ...
        public void Ignore_NonMatching_Is_Failure()
        {
            var pattern = Parse.Character.UppercaseLetter;
            var actual = Ignore(pattern)(_reader).IsAtom;
    ...
    public class IgnoreParserTests
    {
        ...
        public void Ignore_Matching_Is_Atom()
        {
            ...
            var actual = Ignore<ReadOnlyMemory<char>>(pattern)(_reader).IsAtom;
    ...
    public class IslandTests
    {
        ...
        public void Island_Match_Is_Atom()
        {
            ...
            var actual = island(reader).IsAtom;
    ...
    public class PositiveLookAheadTests
    {
        ...
        {
            var actual = IfFollowedBy(Atom("a"), Atom("b"))(_reader).IsAtom;
    ...
    public class PositiveLookBehindTests
    {
        ...
        public void IfPrecededBy_Matching_Is_Atom()
        {
            ...
            var actual = IfPrecededBy(Atom("0123"), Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        public void IfPrecededBy_NonMatching_Is_Failure()
        {
            ...
            var actual = IfPrecededBy(Atom("0123"), Parse.Character.UppercaseLetter)(_reader).IsAtom;
    ...
    public class MaximumTests
    {
        ...
        [Fact]
        public void Maximum_Matching_Zero_Times_Is_EmptyAtom()
        {
        ...
        {
            var actual = Maximum(1, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = Maximum(27, Parse.Character.LowercaseLetter)(_reader).IsAtom;
    ...
    public class MinimumTests
    {
        ...
        [Fact]
        public void Minimum_Matching_Zero_Times_Is_EmptyAtom()
        {
        ...
        {
            var actual = Minimum(1, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = Minimum(27, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = Minimum(25, Parse.Character.LowercaseLetter)(_reader).IsAtom;
    ...
    public class NegativeLookBehindTests
    {
        ...
        public void NotPrecededBy_Matching_Is_Failure()
        {
            ...
            var actual = NotPrecededBy(Atom("0123"), Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        public void NotPrecededBy_NonMatching_Is_Atom()
        {
            ...
            var actual = NotPrecededBy(Atom("0123"), Parse.Character.UppercaseLetter)(_reader).IsAtom;
    ...
    public class NegativeLookAheadTests
    {
        ...
        {
            var actual = NotFollowedBy(Atom("a"), Atom("b"))(_reader).IsAtom;
    ...
    public class NotExactlyTests
    {
        ...
        {
            var actual = NotExactly(2, Atom('a'))(_reader).IsAtom;
        ...
        {
            var actual = NotExactly(TestOffset, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = NotExactly(1, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        public void NotExactly_Full_Match_Is_Atom()
        {
            ...
            var actual = NotExactly(1, Parse.Character.LowercaseLetter)(reader).IsAtom;
    ...
    public class OptionalTests
    {
        ...
        {
            var actual = Optional(Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = Optional(Parse.Character.UppercaseLetter)(_reader).IsAtom;
    ...
    public class OrTests
    {
        ...
        {
            var actual = Or(Atom('A'), Atom('B'))(_reader).IsAtom;
    ...
    public class RangeTests
    {
        ...
        [Fact]
        public void Range_Matching_Zero_Times_Is_EmptyAtom()
        {
            var actual = Range(0, 0, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = Range(1, 26, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = Range(27, 27, Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = Range(26, 1, Parse.Character.LowercaseLetter)(_reader).IsAtom;
    ...
    public class SatisfiesTests
    {
        ...
        {
            var actual = Satisfies(Atom('a'), CharIsB)(_reader).IsAtom;
        ...
        {
            var actual = Satisfies(Atom('A'), CharIsA)(_reader).IsAtom;
    ...
    public class StartOfTextTests
    {
        ...
        [Fact]
        public void SOT_AtBeginning_Is_EmptyAtom()
        {
        ...
        public void SOT_NotFollowedBy_AtBeginning_Is_Failure()
        {
            ...
            var actual = StartOfText(_reader).IsAtom;
    ...
    public class AtomTests
    {
        ...
        {
            var actual = Atom('a')(_reader).IsAtom;
        ...
        {
            var actual = Atom('0')(_reader).IsAtom;
        ...
        {
            var actual = Atom("abcd")(_reader).IsAtom;
        ...
        {
            var actual = Atom("0123")(_reader).IsAtom;
        ...
        {
            var actual = Parse.Character.LowercaseLetter(_reader).IsAtom;
        ...
        {
            var actual = Parse.Character.UppercaseLetter(_reader).IsAtom;
    ...
    public class TryBindTests
    {
        ...
        {
            var actual = TryBind(Atom('A'), a => Succeed(a))(_reader).IsAtom;
    ...
    public class ZeroOrMoreTests
    {
        ...
        {
            var actual = ZeroOrMore(Parse.Character.UppercaseLetter)(_reader).IsAtom;
        ...
        {
            var actual = ZeroOrMore(Parse.Character.LowercaseLetter)(_reader).IsAtom;
        ...
        {
            var reader = new TextScanner(TestText[0..TestOffset]);
            var actual = ZeroOrMore(Parse.Character.LowercaseLetter)(reader).IsAtom;
