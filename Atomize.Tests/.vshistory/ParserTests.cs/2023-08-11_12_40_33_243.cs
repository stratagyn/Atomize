...
public static partial class AtomizeTests
{
    ...
    public class SatisfiesTests
    {
        ...
        [Fact]
        public void Satisfies_Matching_Passes_Rule_Test_Is_Token()
        {
        ...
        [Fact]
        public void Satisfies_Matching_Passes_Rule_Test_AdvancesOffset()
        {
            var expected = _reader.Offset + 1;
        ...
        {
            var actual = Satisfies(Literal('a'), CharIsB)(_reader).IsSuccess;
