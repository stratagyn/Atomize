...
public static partial class AtomizeTests
{
    ...
    public class SequenceTests
    {
        ...
        [Fact]
        public void Sequence_Empty_Is_Successful()
        {
            var actual = Sequence()(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Sequence_Match_Is_Successful()
        {
        ...
        [Fact]
        public void Sequence_Match_NoRead_Is_Successful()
        {
            var sequence = Sequence(
                Consume('a'),
                Consume('b'),
        ...
        [Fact]
        public void Sequence_Match_ReadFirstMatchOnly_Is_Successful()
        {
            var sequence = Sequence(
                Token.Character('a'),
                Consume('b'),
        ...
        {
            var actual = Sequence(Token.Character('A'))(_reader).IsSuccess;
    ...
    public class ProjectionTests
    {
        ...
        public ProjectionTests() => _reader = new TokenReader(TestText);

        [Fact]
        public void Projection_Empty_Is_Successful()
        {
            var actual = Projection()(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Projection_Match_Is_Successful()
        {
            var sequence = Projection(
                Token.Character('a'),
                Token.Character('b'),
                Token.Character('c'),
                Token.Character('d'));
        ...
        [Fact]
        public void Projection_Match_AdvancesOffset()
        {
            var expected = _reader.Offset + 4;
            var sequence = Projection(
                Token.Character('a'),
        ...
        [Fact]
        public void Projection_Match_NoRead_Is_Successful()
        {
            var sequence = Projection(
                Consume('a'),
                Consume('b'),
        ...
        [Fact]
        public void Projection_Match_NoRead_AdvancesOffset()
        {
            var expected = _reader.Offset + 4;
            var sequence = Projection(
                Consume('a'),
        ...
        [Fact]
        public void Projection_Match_ReadFirstMatchOnly_Is_Successful()
        {
            var sequence = Projection(
                Token.Character('a'),
                Consume('b'),
        ...
        [Fact]
        public void Projection_Match_ReadFirstMatchOnly_AdvancesOffset()
        {
            var expected = _reader.Offset + 4;
            var sequence = Projection(
                Token.Character('a'),
        ...
        [Fact]
        public void Projection_StartingWith_NonMatch_Is_Failure()
        {
            var actual = Projection(Token.Character('A'))(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Projection_NonMatch_Is_Successful()
        {
            var sequence = Projection(
                Token.Character('a'),
                Token.Character('0'));
        ...
        [Fact]
        public void Projection_NonMatch_AdvancesOffset_ByFirstMatch()
        {
            var expected = _reader.Offset + 1;
            var sequence = Projection(
                Token.Character('a'),
    ...
    public class LongestPrefixTests
    {
        ...
        [Fact]
        public void LongestPrefix_Empty_Is_Successful()
        {
            var actual = LongestPrefix()(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void LongestPrefix_Match_Is_Successful()
        {
            ...
            Assert.True((char)((List<ParseResult>)parse.Token)[3].Token! == 'd');
        }
        ...
        [Fact]
        public void LongestPrefix_Match_NoRead_Is_Successful()
        {
            var sequence = LongestPrefix(
                Consume('a'),
                Consume('b'),
        ...
        [Fact]
        public void LongestPrefix_Match_ReadFirstMatchOnly_Is_Successful()
        {
            var sequence = LongestPrefix(
                Token.Character('a'),
                Consume('b'),
        ...
        {
            var actual = LongestPrefix(Token.Character('A'))(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void LongestPrefix_NonMatch_Is_Successful()
        {
            var sequence = LongestPrefix(
                Token.Character('a'),
                Token.Character('b'),
