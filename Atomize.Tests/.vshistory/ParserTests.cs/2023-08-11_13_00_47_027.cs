...
public static partial class AtomizeTests
{
    ...
    public class MaximumTests
    {
        ...
        [Fact]
        public void Maximum_Matching_Zero_Is_EmptyToken()
        {
        ...
        [Fact]
        public void Maximum_Matching_Exact_Count_Is_Token()
        {
        ...
        public void Maximum_Matching_Exact_Count_AdvancesOffset()
        {
            ...
            _ = Maximum(26, Literal(Lowercase))(_reader);
        ...
        [Fact]
        public void Maximum_Matching_LessThan_Count_Is_Token()
        {
    ...
    public class MinimumTests
    {
        ...
        public void Minimum_Matching_GreaterThan_MinTimes_AdvancesOffset()
        {
            ...
            _ = Minimum(25, Literal(Lowercase))(_reader);
