...
public static partial class AtomizeTests
{
    ...
    public class RangeTests
    {
        ...
        [Fact]
        public void Range_Matching_Rule_Zero_Times_Is_EmptyToken()
        {
        ...
        [Fact]
        public void Range_Matching_Rule_AtLeast_Min_Is_Token()
        {
            var actual = Range(pattern, 1, 26)(_reader).IsToken;
        ...
        {
            var actual = Range(pattern, 27, 27)(_reader).IsToken;
        ...
        {
            var actual = Range(pattern, -1, 26)(in _reader).IsToken;
        ...
        {
            var actual = Range(pattern, 26, 1)(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Range_Matching_Rule_Max_LessThan_Min_DoesNot_AdvanceOffset()
        {
            _ = Range(Literal(Lowercase), 26, 1)(_reader);
