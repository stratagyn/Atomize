...
public static partial class AtomizeTests
{
    ...
    public class ZeroOrMoreTests
    {
        ...
        [Fact]
        public void ZeroOrMore_Matching_Character_Zero_Is_Successful()
        {
            var pattern = 'b';
            var actual = ZeroOrMore(pattern)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void ZeroOrMore_Matching_Character_GreaterThanZero_Is_Successful()
        {
            var pattern = 'a';
            var actual = ZeroOrMore(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void ZeroOrMore_Matching_Character_GreaterThanZero_AdvancesOffset()
        {
            var pattern = 'a';
            var expected = _reader.Offset + 1;

            _ = ZeroOrMore(pattern)(in _reader);
        ...
        [Fact]
        public void ZeroOrMore_Matching_String_Zero_Is_Successful()
        {
            var pattern = "b";
            var actual = ZeroOrMore(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void ZeroOrMore_Matching_String_GreaterThanZero_Is_Successful()
        {
            var pattern = "a";
            var actual = ZeroOrMore(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void ZeroOrMore_Matching_String_GreaterThanZero_AdvancesOffset()
        {
            var pattern = "a";
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void ZeroOrMore_Matching_Regex_Zero_Is_Successful()
        {
        ...
        [Fact]
        public void ZeroOrMore_Matching_Regex_GreaterThanZero_Is_Successful()
        {
        ...
        [Fact]
        public void ZeroOrMore_Matching_Regex_GreaterThanZero_AdvancesOffset()
        {
            var pattern = Character.LowercaseLetter;
        ...
        [Fact]
        public void ZeroOrMore_Matching_Rule_Zero_Is_Successful()
        {
        ...
        [Fact]
        public void ZeroOrMore_Matching_Rule_GreaterThanZero_Is_Successful()
        {
        ...
        [Fact]
        public void ZeroOrMore_Matching_Rule_GreaterThanZero_AdvancesOffset()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var expected = _reader.Offset + 26;
