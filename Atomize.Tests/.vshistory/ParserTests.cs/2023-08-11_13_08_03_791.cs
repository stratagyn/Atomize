...
public static partial class AtomizeTests
{
    ...
    public class MinimumTests
    {
        ...
        {
            var parsed = Minimum(0, Literal(Lowercase))(_reader);
    ...
    public class OptionalTests
    {
        ...
        [Fact]
        public void Optional_Matching_Character_Zero_Is_Successful()
        {
            var pattern = 'b';
            var actual = Optional(Literal('b')(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Optional_Matching_Character_One_Is_Successful()
        {
            var pattern = 'a';
            var actual = Optional(pattern)(_reader).IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Optional_Matching_Character_One_AdvancesOffset()
        {
            var pattern = 'a';
            var expected = _reader.Offset + 1;

            _ = Optional(pattern)(in _reader);
        ...
        [Fact]
        public void Optional_Matching_String_Zero_Is_Successful()
        {
            var pattern = "b";
            var actual = Optional(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Optional_Matching_String_One_Is_Successful()
        {
            var pattern = "a";
            var actual = Optional(pattern)(_reader).IsSuccess;
        ...
        [Fact]
        public void Optional_Matching_String_One_AdvancesOffset()
        {
            var pattern = "a";
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void Optional_Matching_Regex_Zero_Is_Successful()
        {
        ...
        [Fact]
        public void Optional_Matching_Regex_One_Is_Successful()
        {
        ...
        [Fact]
        public void Optional_Matching_Regex_One_AdvancesOffset()
        {
            var pattern = Character.LowercaseLetter;
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void Optional_Matching_Rule_Zero_Is_Successful()
        {
        ...
        [Fact]
        public void Optional_Matching_Rule_One_Is_Successful()
        {
        ...
        [Fact]
        public void Optional_Matching_Rule_One_AdvancesOffset()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var expected = _reader.Offset + 1;
