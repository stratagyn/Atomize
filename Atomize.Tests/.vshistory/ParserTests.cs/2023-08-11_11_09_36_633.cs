...
public static partial class AtomizeTests
{
    ...
    public class InterleaveRulesTests
    {
        private static readonly Parser[] RuleTokens = new Parser[] {
                Token.String("foo"), Token.String("bar"), Token.String("baz"), Token.String("qux")
            };

        [Fact]
        public void Interleave_EmptyRules_MatchingCharacter_Is_Successful()
        {
            var reader = new TokenReader("a b c d");
            var parse = Interleave(' ', Array.Empty<Parser>())(reader);
            var actual = parse.IsSuccess;

            Assert.True(actual);
        }

        [Fact]
        public void Interleave_Space_MatchingRules_MatchingCharacter_Is_Successful()
        {
            var reader = new TokenReader("foo bar baz qux");
            var parse = Interleave(' ', RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_MatchingCharacter_Advances_Offset()
        {
            var reader = new TokenReader("foo bar baz qux");
        ...
        [Fact]
        public void Interleave_Space_NonMatchingRules_MatchingCharacter_Is_Failure()
        {
        ...
        [Fact]
        public void Interleave_Space_EndingWith_NonMatchingRules_MatchingCharacter_Is_Failure()
        {
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_NonMatchingCharacter_Is_Failure()
        {
        ...
        [Fact]
        public void Interleave_Space_NonMatchingRules_NonMatchingCharacter_Is_Failure()
        {
        ...
        [Fact]
        public void Interleave_EmptyRules_MatchingString_Is_Successful()
        {
            var reader = new TokenReader("a b c d");
            var parse = Interleave(" ", Array.Empty<Parser>())(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_MatchingString_Is_Successful()
        {
            var reader = new TokenReader("foo bar baz qux");
            var parse = Interleave(" ", RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_MatchingString_Advances_Offset()
        {
            var reader = new TokenReader("foo bar baz qux");
            var expected = reader.Offset + 15;
            var parse = Interleave(" ", RuleTokens)(reader);
        ...
        [Fact]
        public void Interleave_Space_NonMatchingRules_MatchingString_Is_Failure()
        {
            var reader = new TokenReader("foo baz bar qux");
            var parse = Interleave(" ", RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_EndingWith_NonMatchingRules_MatchingString_Is_Failure()
        {
            var reader = new TokenReader("foo bar baz quux");
            var parse = Interleave(" ", RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_NonMatchingString_Is_Failure()
        {
            var reader = new TokenReader("foobarbazqux");
            var parse = Interleave(" ", RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_NonMatchingRules_NonMatchingString_Is_Failure()
        {
            var reader = new TokenReader("foobarbazquux");
            var parse = Interleave(" ", RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_EmptyRules_MatchingRegex_Is_Successful()
        {
            var reader = new TokenReader("a b c d");
            var parse = Interleave(Character.Whitespace, Array.Empty<Parser>())(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_MatchingRegex_Is_Successful()
        {
            var reader = new TokenReader("foo bar baz qux");
            var parse = Interleave(Character.Whitespace, RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_MatchingRegex_Advances_Offset()
        {
            var reader = new TokenReader("foo bar baz qux");
            var expected = reader.Offset + 15;
            var parse = Interleave(Character.Whitespace, RuleTokens)(reader);
        ...
        [Fact]
        public void Interleave_Space_NonMatchingRules_MatchingRegex_Is_Failure()
        {
            var reader = new TokenReader("foo baz bar qux");
            var parse = Interleave(Character.Whitespace, RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_EndingWith_NonMatchingRules_MatchingRegex_Is_Failure()
        {
            var reader = new TokenReader("foo bar baz quux");
            var parse = Interleave(Character.Whitespace, RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_NonMatchingRegex_Is_Failure()
        {
            var reader = new TokenReader("foobarbazqux");
            var parse = Interleave(Character.Whitespace, RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_NonMatchingRules_NonMatchingRegex_Is_Failure()
        {
            var reader = new TokenReader("foobarbazquux");
            var parse = Interleave(Character.Whitespace, RuleTokens)(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_EmptyRules_MatchingRule_Is_Successful()
        {
            var reader = new TokenReader("a b c d");
            var parse = Interleave(Token.Character(' '), Array.Empty<Parser>())(reader);
            var actual = parse.IsSuccess;
        ...
        [Fact]
        public void Interleave_Space_MatchingRules_MatchingRule_Is_Successful()
        {
            var reader = new TokenReader("foo bar baz qux");
            var parse = Interleave(Token.Character(' '), RuleTokens)(reader);
            var actual = parse.IsSuccess;
