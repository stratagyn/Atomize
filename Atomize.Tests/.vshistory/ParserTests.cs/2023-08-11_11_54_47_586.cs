...
public static partial class AtomizeTests
{
    ...
    public class PositiveLookAheadTests
    {
        ...
        [Fact]
        public void IfFollowedBy_NonMatching_Rule_DoesNotFollowedBy_AdvanceOffset()
        {
            var expected = _reader.Offset;
        ...
        [Fact]
        public void IfFollowedBy_NonMatching_Start_DoesNotFollowedBy_AdvanceOffset()
        {
            var expected = _reader.Offset;
    ...
    public class PositiveLookBehindTests
    {
        ...
        public void IfPrecededBy_Matching_Rule_Is_Token()
        {
            ...
            var actual = IfPrecededBy(Literal("a"), Literal(""))(_reader).IsToken;
        ...
        public void IfPrecededBy_Matching_Rule_AdvancesOffset()
        {
            ...
            _ = IfPrecededBy(Literal("a"), Literal("b"))(_reader);
        ...
        public void IfPrecededBy_NonMatching_Rule_Is_Failure()
        {
            ...
            var actual = IfPrecededBy(Literal("A"), Literal("b"))(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void IfPrecededBy_NonMatching_Rule_DoesNotPrecededBy_AdvanceOffset()
        {
            var expected = _reader.Offset;
        ...
        [Fact]
        public void IfPrecededBy_NonMatching_Start_DoesNotPrecededBy_AdvanceOffset()
        {
            var expected = _reader.Offset;
    ...
    public class NegativeLookBehindTests
    {
        ...
        {
            var actual = NotPrecededBy(Literal("a"), Literal("b"))(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void NotPrecededBy_Matching_Rule_DoesNotPrecededBy_AdvanceOffset()
        {
            var pattern = Literal("abcd");
            var expected = _reader.Offset;

            _ = NotPrecededBy(Literal("a"), Literal("b"))(_reader);
        ...
        public void NotPrecededBy_NonMatching_Rule_AdvancesOffset()
        {
            ...
            _ = NotPrecededBy(Literal("a"), Literal("B"));
    ...
    public class NegativeLookAheadTests
    {
        ...
        [Fact]
        public void NotFollowedBy_Matching_Rule_DoesNotFollowedBy_AdvanceOffset()
        {
            var pattern = Literal("abcd");
            var expected = _reader.Offset;
        ...
        [Fact]
        public void NotFollowedBy_NonMatching_Start_DoesNotFollowedBy_AdvanceOffset()
        {
            var expected = _reader.Offset;
