...
public static partial class AtomizeTests
{
    ...
    public class IslandTests
    {
        ...
        {
            var reader = new TokenReader("(TEST)");
        ...
        {
            var reader = new TokenReader("(EST)");
    ...
    public class JoinTests
    {
        ...
        public void Join_Space_MatchingRules_MatchingRule_Is_Token()
        {
            ...
            var parse = Join(Literal(" "), RuleTokens)(reader);
            var actual = parse.IsToken;
        ...
        public void Join_Space_MatchingRules_MatchingRule_Advances_Offset()
        {
            ...
            var _ = Join(Literal(" "), RuleTokens)(reader);
            var actual = reader.Offset;
    ...
    public class LiteralTests
    {
        ...
        public LiteralTests() => _reader = new TokenReader(TestText);

        [Fact]
        public void Literal_Matching_Char_Is_Token()
        {
            var actual = Literal('a')(_reader).IsToken;

            Assert.True(actual);
        }

        [Fact]
        public void Literal_Matching_Char_AdvancesOffset()
        {
            var expected = _reader.Offset + 1;
        ...
        [Fact]
        public void Literal_NonMatching_Char_Is_Failure()
        {
            var actual = Literal('0')(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Literal_NonMatching_Char_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;
        ...
        [Fact]
        public void Literal_Matching_String_Is_Token()
        {
            var actual = Literal("abcd")(_reader).IsToken;

            Assert.True(actual);
        }

        [Fact]
        public void Literal_Matching_String_AdvancesOffset()
        {
            var expected = _reader.Offset + 4;

            _ = Literal("abcd")(_reader);
        ...
        [Fact]
        public void Literal_NonMatching_String_Is_Failure()
        {
            var actual = Literal("0123")(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Literal_NonMatching_String_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;

            _ = Literal("0123")(_reader);
        ...
        [Fact]
        public void Literal_Matching_Regex_Is_Token()
        {
            var actual = Literal(Lowercase)(_reader).IsToken;

            Assert.True(actual);
        }

        [Fact]
        public void Literal_Matching_Regex_AdvancesOffset()
        {
            var expected = _reader.Offset + 1;

            _ = Literal(Lowercase)(_reader);
        ...
        [Fact]
        public void Literal_NonMatching_Regex_Is_Failure()
        {
            var actual = Literal(Uppercase)(_reader).IsToken;

            Assert.False(actual);
        }

        [Fact]
        public void Literal_NonMatching_Regex_DoesNot_AdvanceOffset()
        {
            var expected = _reader.Offset;

            _ = Literal(Uppercase)(_reader);
    ...
    public class MaximumTests
    {
        ...
        {
            var parsed = Maximum(0, Literal(Lowercase))(_reader);
        ...
        {
            var actual = Maximum(1, Literal(Lowercase))(_reader).IsToken;
        ...
        public void Maximum_Matching_Exactly_Max_Times_AdvancesOffset()
        {
            ...
            _ = Maximum(TestOffset, Literal(Lowercase))(_reader);
        ...
        {
            var actual = Maximum(27, Literal(Lowercase))(_reader).IsToken;
        ...
        public void Maximum_Matching_LessThan_Max_Times_AdvancesOffset()
        {
            ...
            _ = Maximum(27, Literal(Lowercase))(_reader);
        ...
        public void Maximum_Matching_Negative_Max_DoesNot_AdvanceOffset()
        {
            ...
            _ = Minimum(-1, Literal(Lowercase))(_reader);
    ...
    public class MinimumTests
    {
        ...
        {
            var parsed = Minimum(0, Literal(Uppercase))(_reader);
        ...
        {
            var actual = Minimum(1, Literal(Lowercase))(_reader).IsToken;
        ...
        public void Minimum_Matching_Exactly_Min_Times_AdvancesOffset()
        {
            ...
            _ = Minimum(TestOffset, Literal(Lowercase))(_reader);
        ...
        {
            var actual = Minimum(27, Literal(Lowercase))(_reader).IsToken;
        ...
        public void Minimum_Matching_LessThan_Min_Times_DoesNot_AdvanceOffset()
        {
            ...
            _ = Minimum(27, Literal(Lowercase))(_reader);
        ...
        {
            var actual = Minimum(25, Literal(Lowercase))(_reader).IsToken;
    ...
    public class NotExactlyTests
    {
        ...
        public NotExactlyTests() => _reader = new TokenReader(TestText);

        [Fact]
        public void NotExactly_Matching_LessThan_N_Times_Is_Token()
        {
            var actual = NotExactly(2, Literal('a'))(_reader).IsToken;
        ...
        public void NotExactly_Matching_LessThan_N_Times_AdvancesOffset()
        {
            ...
            _ = NotExactly(2, Literal('a'))(_reader);
        ...
        {
            var actual = NotExactly(TestOffset, Literal(Lowercase))(_reader).IsToken;
        ...
        public void NotExactly_Matching_Exactly_N_Times_DoesNot_AdvanceOffset()
        {
            ...
            _ = NotExactly(TestOffset, Literal(Lowercase))(_reader);
        ...
        {
            var actual = NotExactly(1, Literal(Lowercase))(_reader).IsToken;
        ...
        public void NotExactly_Matching_GreaterThan_N_Times_AdvancesOffset()
        {
            ...
            _ = NotExactly(1, Literal(Lowercase))(_reader);
        ...
        {
            var reader = new TokenReader(TestText[0..TestOffset]);
            var actual = NotExactly(1, Literal(Lowercase))(reader).IsToken;
        ...
        public void NotExactly_Full_Match_AdvancesOffset()
        {
            ...
            _ = NotExactly(1, Literal(Lowercase))(reader);
    ...
    public class OptionalTests
    {
        ...
        public OptionalTests() => _reader = new TokenReader(TestText);

        [Fact]
        public void Optional_Matching_Is_Token()
        {
            var actual = Optional(Literal(Lowercase))(_reader).IsToken;
        ...
        public void Optional_Matching_AdvancesOffset()
        {
            ...
            _ = Optional(Literal(Lowercase))(_reader);
        ...
        {
            var actual = Optional(Literal(Uppercase))(_reader).IsToken;
        ...
        public void Optional_NonMatching_DoesNot_AdvanceOffset()
        {
            ...
            _ = Optional(Literal(Uppercase))(_reader);
    ...
    public class OrTests
    {
        ...
        public OrTests() => _reader = new TokenReader(TestText);

        [Fact]
        public void Or_Match_First_Is_Token()
        {
            var sequence = Or(Literal('a'), Literal('A'));
        ...
        {
            var sequence = Or(Literal('a'), Literal('b'));
        ...
        {
            var actual = Or(Literal('A'), Literal('B'))(_reader).IsToken;
        ...
        public void Or_Match_None_DoesNot_AdvanceOffset()
        {
            ...
            _ = Or(Literal('A'), Literal('B'))(_reader);
    ...
    public class UntilTests
    {
        ...
        public UntilTests() => _reader = new TokenReader(TestText);

        [Fact]
        public void Until_Matching_Is_Token()
        {
            var parsed = Until(Literal('0'))(_reader);
        ...
        {
            var parsed = Until(Literal(' '))(_reader);
    ...
    public class ZeroOrMoreTests
    {
        ...
        {
            var reader = new TokenReader(TestText[0..TestOffset]);
            var actual = ZeroOrMore(Literal(Lowercase))(reader).IsToken;
        ...
        public void ZeroOrMore_FullMatch_AdvancesOffset()
        {
            ...
            _ = ZeroOrMore(Literal(Lowercase))(reader);
