...
public static partial class AtomizeTests
{
    ...
    public class IslandTests
    {
        ...
        public IslandTests() => _reader = new TokenReader(TestText);

        [Fact]
        public void Island_Empty_Is_EmptyToken()
        {
            var parsed = Island<char>()(_reader);
        ...
        [Fact]
        public void Island_Match_NoRead_Is_Token()
        {
            var sequence = Island(
                Ignore(Literal('a')),
                Ignore(Literal('b')),
        ...
        [Fact]
        public void Island_Match_NoRead_AdvancesOffset()
        {
            var expected = _reader.Offset + 4;
            var sequence = Island(
                Ignore(Literal('a')),
        ...
        [Fact]
        public void Island_Match_ReadFirstMatchOnly_Is_Token()
        {
            var sequence = Island(
                Literal('a'),
                Ignore(Literal('b')),
        ...
        [Fact]
        public void Island_Match_ReadFirstMatchOnly_AdvancesOffset()
        {
            var expected = _reader.Offset + 4;
            var sequence = Island(
                Literal('a'),
        ...
        {
            var actual = Island(Literal('A'))(_reader).IsToken;
        ...
        [Fact]
        public void Island_NonMatch_AfterMatch_Is_Failure()
        {
            var sequence = Island(
                Literal('a'),
                Literal('b'),
