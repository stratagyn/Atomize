...
public static partial class AtomizeTests
{
    ...
    public class MaximumTests
    {
        ...
        {
            var actual = Maximum(Literal(Lowercase), 0)(_reader).IsToken;
        ...
        {
            var actual = Maximum(Literal(Lowercase), 1)(_reader).IsToken;
        ...
        public void Maximum_Matching_Exact_Count_AdvancesOffset()
        {
            ...
            _ = Maximum(Literal(Lowercase), 26)(_reader);
        ...
        {
            var actual = Maximum(Literal(Lowercase), 27)(_reader).IsToken;
    ...
    public class MinimumTests
    {
        ...
        {
            var Literal(Lowercase) = Token.Character(Character.LowercaseLetter);
            var actual = Minimum(Literal(Lowercase), 0)(_reader).IsToken;
        ...
        {
            var actual = Minimum(Literal(Lowercase), 1)(_reader).IsToken;
        ...
        public void Minimum_Matching_Exact_Count_AdvancesOffset()
        {
            ...
            _ = Minimum(Literal(Lowercase), 26)(_reader);
        ...
        {
            var Literal(Lowercase) = Token.Character(Character.LowercaseLetter);
            var actual = Minimum(Literal(Lowercase), 27)(_reader).IsToken;
        ...
        {
            var Literal(Lowercase) = Token.Character(Character.LowercaseLetter);
            var actual = Minimum(Literal(Lowercase), 25)(_reader).IsToken;
