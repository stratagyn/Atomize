...
public static partial class AtomizeTests
{
    ...
    public class SatisfiesTests
    {
        ...
        private static readonly Predicate<string> StrIsA = s => s == "a";
        private static readonly Predicate<string> StrIsB = s => s == "b";
        private static readonly Predicate<object?> ObjIsA = o => o?.ToString() == "a";
        private static readonly Predicate<object?> ObjIsB = o => o?.ToString() == "b";
        ...
        [Fact]
        public void Satisfies_Passes_Character_Test_Is_Successful()
        {
            var parse = Satisfies(CharIsA)(_reader);
            var success = parse.IsSuccess;

            Assert.True(success);
        }

        [Fact]
        public void Satisfies_Passes_Character_Test_AdvancesOffset()
        {
            var expected = _reader.Offset + 1;

            _ = Satisfies(CharIsA)(_reader);
            var actual = _reader.Offset;
        ...
        [Fact]
        public void Satisfies_Fails_Character_Test_Is_Failure()
        {
            var actual = Satisfies(CharIsB)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_Passes_Regex_Test_Is_Successful()
        {
            var pattern = Character.LowercaseLetter;

            var parse = Satisfies(pattern, StrIsA)(_reader);
            var success = parse.IsSuccess;
        ...
        [Fact]
        public void Satisfies_Passes_Regex_Test_AdvancesOffset()
        {
            var pattern = Character.LowercaseLetter;
            var expected = _reader.Offset + 1;

            _ = Satisfies(pattern, StrIsA)(_reader);
            var actual = _reader.Offset;
        ...
        [Fact]
        public void Satisfies_Matching_Fails_Regex_Test_Is_Failure()
        {
            var pattern = Character.LowercaseLetter;
            var actual = Satisfies(pattern, StrIsB)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_NonMatching_Regex_Is_Failure()
        {
            var pattern = Character.UppercaseLetter;
            var actual = Satisfies(pattern, StrIsA)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_Passes_Rule_Test_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);

            var parse = Satisfies(pattern, ObjIsA)(_reader);
            var success = parse.IsSuccess;
        ...
        [Fact]
        public void Satisfies_Passes_Rule_Test_AdvancesOffset()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var expected = _reader.Offset + 1;

            _ = Satisfies(pattern, ObjIsA)(_reader);
            var actual = _reader.Offset;
        ...
        [Fact]
        public void Satisfies_Matching_Fails_Rule_Test_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Satisfies(pattern, ObjIsB)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_NonMatching_Rule_Is_Failure()
        {
            var pattern = Token.Character(Character.UppercaseLetter);
            var actual = Satisfies(pattern, ObjIsA)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_Passes_Rule_Test_Matching_Predicate_Is_Successful()
        {
            var pattern = Token.Character(Character.LowercaseLetter);

            var parse = Satisfies(pattern, CharIsA)(_reader);
            var success = parse.IsSuccess;
        ...
        [Fact]
        public void Satisfies_Passes_Rule_Test_Matching_Predicate_AdvancesOffset()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var expected = _reader.Offset + 1;

            _ = Satisfies(pattern, CharIsA)(_reader);
            var actual = _reader.Offset;
        ...
        [Fact]
        public void Satisfies_Matching_Fails_Rule_Test_Matching_Predicate_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Satisfies(pattern, CharIsB)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_NonMatching_Rule_Is_Matching_Predicate_Is_Failure()
        {
            var pattern = Token.Character(Character.UppercaseLetter);
            var actual = Satisfies(pattern, CharIsA)(_reader).IsSuccess;

            Assert.False(actual);
        }

        [Fact]
        public void Satisfies_Fails_Rule_Test_NonMatching_Predicate_Is_Failure()
        {
            var pattern = Token.Character(Character.LowercaseLetter);
            var actual = Satisfies(pattern, StrIsA)(_reader).IsSuccess;
