...
public static partial class AtomizeTests
{
    ...
    public class OrTests
    {
        ...
        [Fact]
        public void Or_Match_First_Is_Successful()
        {
            var sequence = Or(Token.Character('a'), Token.Character('A'));
        ...
        [Fact]
        public void Or_Match_Second_Is_Successful()
        {
            var sequence = Or(Token.Character('A'), Token.Character('a'));
        ...
        [Fact]
        public void Or_Match_Both_Is_Successful()
        {
            var sequence = Or(Token.Character('a'), Token.Character('b'));
        ...
        {
            var actual = Or(Token.Character('A'), Token.Character('B'))(_reader).IsSuccess;
