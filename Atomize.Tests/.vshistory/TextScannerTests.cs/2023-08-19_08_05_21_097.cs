...
public partial class AtomizeTests
{
    public class TokenReaderTests
    {
        ...
        public TokenReaderTests() => _reader = new TextScanner(TestText);
        ...
        {
            var actual = _reader.StartsWith(Pattern.Char.LowercaseLetter);
        ...
        {
            var actual = _reader.StartsWith(Pattern.Text.Number);
