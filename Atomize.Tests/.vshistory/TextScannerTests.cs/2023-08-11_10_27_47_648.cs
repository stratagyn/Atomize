...
public partial class FarseTests
{
    public class TokenReaderTests
    {
        ...
        [Fact]
        public void Peek_Is_CharacterAtCurrentOffset()
        {
            var expected = TestText[_reader.Offset];
            var actual = _reader.Peek();

            Assert.Equal(expected, actual);
        }

        [Fact]
        public void Peek_Offset_Is_Unchanged()
        {
        ...
        [Fact]
        public void PeekAtEnd_Throws_InvalidOperationException()
        {
            _reader.Advance(TestText.Length);

            Assert.Throws<InvalidOperationException>(() => _reader.Peek());
        }

        [Fact]
        public void PeekN_Is_StringAtCurrentOffset()
        {
            var expected = TestText[0..TestOffset];
            var actual = _reader.Peek(TestOffset);

            Assert.Equal(expected, actual);
        }

        [Fact]
        public void PeekN_Offset_Is_Unchanged()
        {
            var expected = _reader.Offset;

            _ = _reader.Peek(TestOffset);
        ...
        [Fact]
        public void PeekPastEnd_Throws_InvalidOperationException() =>
            Assert.Throws<InvalidOperationException>(() => _reader.Peek(TestText.Length + 1));

        [Fact]
        public void PeekNegativeCount_Throws_InvalidOperationException() =>
            Assert.Throws<InvalidOperationException>(() => _reader.Peek(-1));
        ...
        [InlineData(0, true)]
        [InlineData(1, false)]
        public void StartsWith_CharacterSet_Matches_ExpectedOutcome(int index, bool expected)
        {
            var actual = _reader.StartsWith(TestText[index..].ToCharArray());

            Assert.Equal(expected, actual);
        }

        [Fact]
        public void StartsWith_CharacterSet_AtEnd_Is_False()
        {
            _reader.Advance(TestText.Length);

            var actual = _reader.StartsWith(TestText[0..].ToCharArray());
        ...
        [Fact]
        public void StartsWith_Matching_StringSet_Is_True()
        {
            var actual = _reader.StartsWith(new string[] { "abcd", "bcde", "0123" });

            Assert.True(actual);
        }

        [Fact]
        public void StartsWith_NonMatching_StringSet_Is_False()
        {
            var actual = _reader.StartsWith(new string[] { "acde", "bcde", "0123" });

            Assert.False(actual);
        }

        [Fact]
        public void StartsWith_StringSet_AtEnd_Is_False()
        {
            _reader.Advance(TestText.Length);
        ...
        {
            var actual = _reader.StartsWith(Text.LowercaseLetter);
        ...
        {
            var actual = _reader.StartsWith(Text.Number);
        ...
        [Fact]
        public void StartsWith_Matching_RegexSet_Is_True()
        {
            var actual = _reader.StartsWith(
                new Regex[] { Text.Number, Text.LowercaseLetter, Text.Punctuation });

            Assert.True(actual);
        }

        [Fact]
        public void StartsWith_NonMatching_RegexSet_Is_False()
        {
            var actual = _reader.StartsWith(
                new Regex[] { Text.Number, Text.UppercaseLetter, Text.Punctuation });

            Assert.False(actual);
        }

        [Fact]
        public void StartsWith_RegexSet_AtEnd_Is_False()
        {
            _reader.Advance(TestText.Length);
        ...
        [Fact]
        public void StartsWith_Matching_RegexSet_AfterAdvancing_Is_True()
        {
            _reader.Advance(TestOffset);
