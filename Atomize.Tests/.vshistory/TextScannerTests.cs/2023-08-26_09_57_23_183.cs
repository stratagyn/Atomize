...
public partial class AtomizeTests
{
    public class TokenReaderTests
    {
        ...
        public TokenReaderTests() => _scanner = new TextScanner(TestText);
        ...
        {
            var actual = Pattern.Char.LowercaseLetter(_scanner).IsToken;
        ...
        {
            var actual = Pattern.Text.Number(_scanner).IsToken;
        ...
        {
            var text = "'this won't be squeezed'";
        ...
        {
            var quoted = "\"this won't be squeezed\"";
        ...
        {
            var text = "\\'this will be squeezed\\'";
            var expected = text.Length - 3;
            var scanner = new TextScanner(text, true);
            var actual = scanner.Length;
